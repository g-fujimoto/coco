...
app.controller('SearchController', ['$scope', '$http', '$uibModal', '$timeout', '$Users', '$Recommend', function ($scope, $http, $uibModal, $timeout, $Users, $Recommend) {
    ...
    $scope.recommendAdd = function (item) {
        $Recommend.add(item._id).success(function (data) {
            if (data.ok === 1) {
