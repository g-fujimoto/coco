...
!function (a, b, c) {
  ...
  (function () {
    ...
    b.module("uiGmapgoogle-maps.providers").factory("uiGmapMapScriptLoader", ["$q", "uiGmapuuid", function (c, d) {
      var e, f, g, h;return h = void 0, e = function e(a) {
        ...
        var b, c, f;return b = ["transport", "isGoogleMapsForWork", "china"], a.isGoogleMapsForWork && b.push("key"), c = _.map(_.omit(a, b), function (a, b) {
          return b + "=" + a;
        ...
        return b.isDefined(a.google) && b.isDefined(a.google.maps);
          ...
          var d, e;return d = c.defer(), g() ? (d.resolve(a.google.maps), d.promise) : (e = b.callback = "onGoogleMapsReady" + Math.round(1e3 * Math.random()), a[e] = function () {
      ...
      return this.options = { transport: "https", isGoogleMapsForWork: !1, china: !1, v: "3", libraries: "", language: "en", sensor: "false" }, this.configure = function (a) {
    ...
    b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapGmapUtil", ["uiGmapLogger", "$compile", function (a, c) {
      var d, e, f, g, h, i;return e = function e(a, b, c) {
        ...
        if (b.isUndefined(a)) return !1;if (_.isArray(a)) {
          if (2 === a.length) return !0;
        } else if (null != a && (null != a ? a.type : void 0) && "Point" === a.type && _.isArray(a.coordinates) && 2 === a.coordinates.length) return !0;return a && b.isDefined((null != a ? a.latitude : void 0) && b.isDefined(null != a ? a.longitude : void 0)) ? !0 : !1;
          ...
          var b, c;return void 0 === a ? void 0 : (a = /^([-\d\.]+)\s([-\d\.]+)$/.exec(a), b = parseFloat(a[1]), c = parseFloat(a[2]), null != b && null != c ? new google.maps.Point(b, c) : void 0);
        }, createWindowOptions: function createWindowOptions(d, e, g, h) {
          var i;return null != g && null != h && null != c ? (i = b.extend({}, h, { content: this.buildContent(e, h, g), position: null != h.position ? h.position : b.isObject(d) ? d.getPosition() : f(e.coords) }), null != d && null == (null != i ? i.pixelOffset : void 0) && (null == i.boxClass || (i.pixelOffset = { height: 0, width: -2 })), i) : h ? h : (a.error("infoWindow defaults not defined"), g ? void 0 : a.error("infoWindow content not defined"));
        }, buildContent: function buildContent(a, b, d) {
          var e, f;return null != b.content ? f = b.content : null != c ? (d = d.replace(/^\s+|\s+$/g, ""), e = "" === d ? "" : c(d)(a), e.length > 0 && (f = e[0])) : f = d, f;
        }, defaultDelay: 50, isTrue: function isTrue(a) {
          return e(a, !0, ["true", "TRUE", 1, "y", "Y", "yes", "YES"]);
        }, isFalse: d, isFalsy: function isFalsy(a) {
          return e(a, !1, [void 0, null]) || d(a);
        }, getCoords: f, validateCoords: i, equalCoords: function equalCoords(a, b) {
          return g(a) === g(b) && h(a) === h(b);
        }, validatePath: function validatePath(a) {
          var c, d, e, f;if (d = 0, b.isUndefined(a.type)) {
            if (!Array.isArray(a) || a.length < 2) return !1;for (; d < a.length;) {
              if (!(b.isDefined(a[d].latitude) && b.isDefined(a[d].longitude) || "function" == typeof a[d].lat && "function" == typeof a[d].lng)) return !1;d++;
            }return !0;
          }if (b.isUndefined(a.coordinates)) return !1;if ("Polygon" === a.type) {
            if (a.coordinates[0].length < 4) return !1;c = a.coordinates[0];
            ...
            if ("LineString" !== a.type) return !1;if (a.coordinates.length < 2) return !1;c = a.coordinates;
          }for (; d < c.length;) {
            if (2 !== c[d].length) return !1;d++;
          }return !0;
        }, convertPathPoints: function convertPathPoints(a) {
          var c, d, e, f, g;if (d = 0, f = new google.maps.MVCArray(), b.isUndefined(a.type)) for (; d < a.length;) {
          ...
          } else for ("Polygon" === a.type ? c = a.coordinates[0] : "MultiPolygon" === a.type ? (g = { max: 0, index: 0 }, _.forEach(a.coordinates, function (a, b) {
            return a[0].length > this.max ? (this.max = a[0].length, this.index = b) : void 0;
          ...
          var c;return null != b && _.isString(b) ? (c = a, _.each(b.split("."), function (a) {
    ...
    b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapEventsHelper", ["uiGmapLogger", function (a) {
      var c, d;return d = function d(a) {
        return b.isDefined(a.events) && null != a.events && b.isObject(a.events);
      }, c = function c(a, b) {
        return d(a) ? a : d(b) ? b : void 0;
      }, { setEvents: function setEvents(a, d, e, f) {
          var g;return g = c(d, e), null != g ? _.compact(_.map(g.events, function (c, h) {
            var i;return f && (i = _(f).contains(h)), g.events.hasOwnProperty(h) && b.isFunction(g.events[h]) && !i ? google.maps.event.addListener(a, h, function () {
          ...
          var b, c;if (a) for (b in a) {
            c = a[b], c && google.maps.event.removeListener(c);
          }
        } };
    }]);
  }.call(this), function () {
            ...
            return function (a) {
              var i, j, k, l, m, n, o, p, q, r;return p = void 0, r = void 0, k = !1, n = void 0, o = null, q = null, i = function i() {
                ...
                var a;return g.focalcoord ? g.radius ? (i(), null == r && (r = new google.maps.StreetViewService()), g.events && (n = e.setEvents(r, g, g)), a = d.getCoords(g.focalcoord), r.getPanoramaByLocation(a, g.radius, function (b, c) {
                  var d, e, f;return null != g.imagestatus && (g.imagestatus = c), null != (null != (f = g.events) ? f.image_status_changed : void 0) && g.events.image_status_changed(r, "image_status_changed", g, c), "OK" === c ? (e = b.location.latLng, m(e, a), d = h[0], p = new google.maps.StreetViewPanorama(d, o)) : void 0;
