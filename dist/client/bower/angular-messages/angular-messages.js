...
(function (window, angular, undefined) {
   ...
   * </example>
   */
  .directive('ngMessages', ['$compile', '$animate', '$http', '$templateCache', function ($compile, $animate, $http, $templateCache) {
    ...
    return {
      ...
      link: function link($scope, element, $attrs, ctrl) {
        ...
        if (tpl) {
          $http.get(tpl, { cache: $templateCache }).success(function processTemplate(html) {
            var after,
  ...
  .directive('ngMessage', ['$animate', function ($animate) {
    ...
    return {
      ...
      terminal: true,
      restrict: 'AE',
      link: function link($scope, $element, $attrs, ngMessages, $transclude) {
        var index, element;
