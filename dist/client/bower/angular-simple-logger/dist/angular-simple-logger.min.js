...
!function e(r, n, o) {
  function t(i, u) {
    if (!n[i]) {
      if (!r[i]) {
        var c = "function" == typeof require && require;if (!u && c) return c(i, !0);if (s) return s(i, !0);var a = new Error("Cannot find module '" + i + "'");throw a.code = "MODULE_NOT_FOUND", a;
    ...
    angular.module("nemLogging", []), angular.module("nemLogging").provider("nemDebug", function () {
      ...
      var r, n, t, s, i, u, c, a, l, f, g;for (f = e.debug, t = ["debug", "info", "warn", "error", "log"], r = {}, a = c = 0, l = t.length; l > c; a = ++c) {
        g = t[a], r[g] = a;
      }return i = function i(e, r, n) {
        return e >= r ? n() : void 0;
      }, s = function s(e) {
        var r, n, o;if (r = !1, !e) return r;for (n = 0, o = t.length; o > n && (g = t[n], r = null != e[g] && "function" == typeof e[g], r); n++) {}return r;
      }, u = function u(e, r) {
        var n, o, s, i;for (n = f(e), i = {}, o = 0, s = t.length; s > o; o++) {
          g = t[o], i[g] = "debug" === g ? n : r[g];
        }return i;
      }, n = function () {
        function e(e) {
          var n, u, c, a, l;if (this.$log = e, this.spawn = o(this.spawn, this), !this.$log) throw "internalLogger undefined";if (!s(this.$log)) throw "@$log is invalid";for (this.doLog = !0, l = {}, n = function (e) {
            return function (n) {
          ...
          }(this), u = 0, c = t.length; c > u; u++) {
            a = t[u], n(a);
          }this.LEVELS = r, this.currentLevel = r.error;
        }return e.prototype.spawn = function (r) {
          if ("string" == typeof r) {
            if (!s(this.$log)) throw "@$log is invalid";if (!f) throw "nemDebug is undefined this is probably the light version of this library sep debug logggers is not supported!";return u(r, this.$log);
    ...
    function o() {
      ...
      function r() {}function t() {
        var e = t,
            r = +new Date(),
            s = r - (a || r);e.diff = s, e.prev = a, e.curr = r, a = r, null == e.useColors && (e.useColors = n.useColors()), null == e.color && e.useColors && (e.color = o());var i = Array.prototype.slice.call(arguments);i[0] = n.coerce(i[0]), "string" != typeof i[0] && (i = ["%o"].concat(i));var u = 0;i[0] = i[0].replace(/%([a-z%])/g, function (r, o) {
          if ("%%" === r) return r;u++;var t = n.formatters[o];if ("function" == typeof t) {
            var s = i[u];r = t.call(e, s), i.splice(u, 1), u--;
          }return r;
        }), "function" == typeof n.formatArgs && (i = n.formatArgs.apply(e, i));var c = t.log || n.log || console.log.bind(console);c.apply(e, i);
    ...
    }n = r.exports = t, n.coerce = c, n.disable = i, n.enable = s, n.enabled = u, n.humanize = e("ms"), n.names = [], n.skips = [], n.formatters = {};var a,
        l = 0;
