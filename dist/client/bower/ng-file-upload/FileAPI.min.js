...
!function (a) {
  ...
  function c(a, b, c, d, e) {
    var f = { type: c.type || c, target: a, result: d };S(f, e), b(f);
  }function d(a) {
    return u && !!u.prototype["readAs" + a];
  }function e(a, e, f, g) {
    if (Y.isBlob(a) && d(f)) {
      var h = new u();T(h, M, function j(b) {
        var d = b.type;"progress" == d ? c(a, e, b, b.target.result, { loaded: b.loaded, total: b.total }) : "loadend" == d ? (U(h, M, j), h = null) : c(a, e, b, b.target.result);
      });try {
    ...
    if (!a.type && a.size % 4096 === 0 && a.size <= 102400) {
      if (u) try {
        var c = new u();V(c, M, function (a) {
          var d = "error" != a.type;b(d), d && c.abort();
        }), c.readAsDataURL(a);
      } catch (d) {
        b(!1);
      } else b(null);
    ...
    var b = {};return R(a, function (a, c) {
      a && "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) && void 0 === a.nodeType && (a = S({}, a)), b[c] = a;
    }), b;
  }function j(a) {
    ...
    return a && "length" in a;
      ...
      R = function R(a, b, c) {
    if (a) if (Q(a)) for (var d = 0, e = a.length; e > d; d++) {
    ...
    for (var b = arguments, c = 1, d = function d(b, c) {
      ...
      T = function T(a, b, c) {
    if (a) {
      var d = Y.uid(a);K[d] || (K[d] = {});var e = u && a && a instanceof u;R(b.split(/\s+/), function (b) {
    ...
    if (a) {
      var d = Y.uid(a),
          e = K[d] || {},
          f = u && a && a instanceof u;R(b.split(/\s+/), function (b) {
    ...
    return b.target || (b.target = a.event && a.event.srcElement || o), 3 === b.target.nodeType && (b.target = b.target.parentNode), b;
      ...
      X = function X(a) {
    var b = o.createElement("input");return b.setAttribute("type", "file"), a in b;
  },
      Y = { version: "2.0.7", cors: !1, html5: !0, media: !1, formData: !0, multiPassResize: !0, debug: !1, pingUrl: !1, multiFlash: !1, flashAbortTimeout: 0, withCredentials: !0, staticPath: "./dist/", flashUrl: 0, flashImageUrl: 0, postNameConcat: function postNameConcat(a, b) {
      return a + (null != b ? "[" + b + "]" : "");
    }, ext2mime: { jpg: "image/jpeg", tif: "image/tiff", txt: "text/plain" }, accept: { "image/*": "art bm bmp dwg dxf cbr cbz fif fpx gif ico iefs jfif jpe jpeg jpg jps jut mcf nap nif pbm pcx pgm pict pm png pnm qif qtif ras rast rf rp svf tga tif tiff xbm xbm xpm xwd", "audio/*": "m4a flac aac rm mpa wav wma ogg mp3 mp2 m3u mod amf dmf dsm far gdm imf it m15 med okt s3m stm sfx ult uni xm sid ac3 dts cue aif aiff wpl ape mac mpc mpp shn wv nsf spc gym adplug adx dsp adp ymf ast afc hps xs", "video/*": "m4v 3gp nsv ts ty strm rm rmvb m3u ifo mov qt divx xvid bivx vob nrg img iso pva wmv asf asx ogm m2v avi bin dat dvr-ms mpg mpeg mp4 mkv avc vp3 svq3 nuv viv dv fli flv wpl" }, uploadRetry: 0, networkDownRetryTimeout: 5e3, chunkSize: 0, chunkUploadRetry: 0, chunkNetworkDownRetryTimeout: 2e3, KB: J(1), MB: J(2), GB: J(3), TB: J(4), EMPTY_PNG: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAC0lEQVQIW2NkAAIAAAoAAggA9GkAAAAASUVORK5CYII=", expando: "fileapi" + new Date().getTime(), uid: function uid(a) {
      return a ? a[Y.expando] = a[Y.expando] || Y.uid() : (++m, Y.expando + m);
    }, log: function log() {
      Y.debug && Y._supportConsoleLog && (Y._supportConsoleLogApply ? console.log.apply(console, arguments) : console.log([].join.call(arguments, " ")));
    }, newImage: function newImage(a, b) {
      var c = o.createElement("img");return b && Y.event.one(c, "error load", function (a) {
        b("error" == a.type, c), c = null;
      }), c.src = a, c;
    }, getXHR: function getXHR() {
      var b;if (w) b = new w();else if (a.ActiveXObject) try {
        b = new ActiveXObject("MSXML2.XMLHttp.3.0");
      } catch (c) {
        b = new ActiveXObject("Microsoft.XMLHTTP");
      }return b;
    }, isArray: Q, support: { dnd: z && "ondrop" in o.createElement("div"), cors: z, html5: y, chunked: A, dataURI: !0, accept: X("accept"), multiple: X("multiple") }, event: { on: T, off: U, one: V, fix: W }, throttle: function throttle(b, c) {
      ...
      var a,
          ...
          for (e.resolve = n, c = b || !1, a = f; f = d.shift();) {
            f(c, a);
          }
    ...
    }, each: R, afor: function afor(a, b) {
      var c = 0,
          d = a.length;Q(a) && d-- ? !function e() {
        b(d != c && e, a[c], c++);
      }() : b(!1);
    }, extend: S, isFile: function isFile(a) {
      ...
      if (Y.isFile(a)) {
        if (r) {
          var f = r.createObjectURL(a);f === b ? c(a, d, "error") : Y.readAsImage(f, d, e);
      ...
      } else if (Y.isCanvas(a)) c(a, d, "load", a);else if (C.test(a.nodeName)) {
        if (a.complete) c(a, d, "load", a);else {
          var g = "error abort load";V(a, g, function i(b) {
            "load" == b.type && r && r.revokeObjectURL(a.src), U(a, g, i), c(a, d, b, a);
          });
        }
      } else if (a.iframe) c(a, d, { type: "error" });else {
        var h = Y.newImage(a.dataURL || a);Y.readAsImage(h, d, e);
      }
    }, checkFileObj: function checkFileObj(a) {
      var b = {},
          c = Y.accept;return "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) ? b = a : b.name = (a + "").split(/\\|\//g).pop(), null == b.type && (b.type = b.name.split(".").pop()), R(c, function (a, c) {
      ...
      var d = [];return c ? (Y.filterFiles(Y.getFiles(a), b, c), null) : (a.jquery && (a.each(function () {
      ...
      var c = {},
          d = L.concat();Y.isFile(a) ? !function e() {
      ...
      a = S({ jsonp: "callback", prepare: Y.F, beforeupload: Y.F, upload: Y.F, fileupload: Y.F, fileprogress: Y.F, filecomplete: Y.F, progress: Y.F, complete: Y.F, pause: Y.F, imageOriginal: !0, chunkSize: Y.chunkSize, chunkUploadRetry: Y.chunkUploadRetry, uploadRetry: Y.uploadRetry }, a), a.imageAutoOrientation && !a.imageTransform && (a.imageTransform = { rotate: "auto" });var _b,
        ...
        var j = d.shift(),
            k = j && j.file,
            l = !1,
            m = i(a);if (c.filesLeft = d.length, k && k.name === Y.expando && (k = null, Y.log("[warn] FileAPI.upload() — called without files")), ("abort" != c.statusText || c.current) && j) {
          if (h = !1, c.currentFile = k, k && a.prepare(k, m) === !1) return void _b.call(e);m.file = k, e._getFormData(m, j, function (h) {
            g || a.upload(c, a);var i = new Y.XHR(S({}, m, { upload: k ? function () {
                a.fileupload(k, i, m);
              ...
              } : n, complete: function complete(d) {
                R(N, function (a) {
                  c[a] = i[a];
          ...
          var o = 200 == c.status || 201 == c.status || 204 == c.status;a.complete(o ? !1 : c.statusText || "error", c, a), h = !0;
        }
      ...
      var b = [],
          c = {};if (j(a)) {
        var d = Y.getFiles(a);c[a.name || "file"] = null !== a.getAttribute("multiple") ? d : d[0];
      } else Q(a) && j(a[0]) ? R(a, function (a) {
        c[a.name || "file"] = Y.getFiles(a);
      }) : c = a;return R(c, function e(a, c) {
        Q(a) ? R(a, function (a) {
          e(a, c);
      ...
      var d = b.file,
        ...
        c(i);
          ...
          k = h && l(h),
          m = Y.postNameConcat;R(a.data, function n(a, b) {
        "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) ? R(a, function (a, c) {
          n(a, m(b, c));
        }) : i.append(b, a);
      }), function o(b) {
      ...
      var c, d;return x ? (d = x(a).clone(!0).insertBefore(a).val("")[0], b || x(a).remove()) : (c = a.parentNode, d = c.insertBefore(a.cloneNode(!0), a), d.value = "", b || c.removeChild(a), R(K[Y.uid(a)], function (b, c) {
        R(b, function (b) {
          U(a, c, b), T(d, c, b);
        });
      })), d;
    }, load: function load(a, b) {
      var c = Y.getXHR();return c ? (c.open("GET", a, !0), c.overrideMimeType && c.overrideMimeType("text/plain; charset=x-user-defined"), T(c, "progress", function (a) {
        ...
        if (4 == c.readyState) if (c.onreadystatechange = null, 200 == c.status) {
          a = a.split("/");var d = { name: a[a.length - 1], size: c.getResponseHeader("Content-Length"), type: c.getResponseHeader("Content-Type") };d.dataURL = "data:" + d.type + ";base64," + Y.encode64(c.responseBody || c.responseText), b({ type: "load", result: d }, c);
        } else b({ type: "error" }, c);
    ...
    if (!a.__dimensions) {
      var c = a.__dimensions = Y.defer();Y.readAsImage(a, function (a) {
        var b = a.target;c.resolve("load" == a.type ? !1 : "error", { width: b.width, height: b.height }), b.src = Y.EMPTY_PNG, b = null;
      });
    }a.__dimensions.then(b);
  }), Y.event.dnd = function (a, b, c) {
    var d, e;c || (c = b, b = Y.F), u ? (T(a, "dragenter dragleave dragover", b.ff = b.ff || function (a) {
      for (var c = k(a).types, f = c && c.length, g = !1; f--;) {
        if (~c[f].indexOf("File")) {
          a[P](), e !== a.type && (e = a.type, "dragleave" != e && b.call(a[O], !0, a), g = !0);break;
        }
  ...
  } catch (Z) {}Y.flashUrl || (Y.flashUrl = Y.staticPath + "FileAPI.flash.swf"), Y.flashImageUrl || (Y.flashImageUrl = Y.staticPath + "FileAPI.flash.image.swf"), Y.flashWebcamUrl || (Y.flashWebcamUrl = Y.staticPath + "FileAPI.flash.camera.swf");
  ...
  function d(b) {
    ...
    h = g().toDataURL("image/png").indexOf("data:image/png") > -1;
      ...
      } else l && (d > h || g > i ? "min" == l ? (h = f(k > j ? e(d, h) : i * j), i = f(k > j ? h / j : e(g, i))) : (h = f(j >= k ? e(d, h) : i * j), i = f(j >= k ? h / j : e(g, i))) : (h = d, i = g));return c.sw = d, c.sh = g, c.dw = h, c.dh = i, c.multipass = a.multiPassResize, c;
  ...
  var c = function c() {},
    ...
    this.uid = b.uid(), this.xhr = { abort: c, getResponseHeader: c, getAllResponseHeaders: c }, this.options = a;
      ...
      var g,
        ...
        }, g = d.createElement("div"), g.innerHTML = '<form target="' + i + '" action="' + k + '" method="POST" enctype="multipart/form-data" style="position: absolute; top: -1000px; overflow: hidden; width: 1px; height: 1px;"><iframe name="' + i + '" src="javascript:false;" onload="' + j + '()"></iframe>' + (l && c.url.indexOf("=?") < 0 ? '<input value="' + i + '" name="' + l + '" type="hidden"/>' : "") + "</form>";var o = g.getElementsByTagName("form")[0],
            p = g.getElementsByTagName("iframe")[0];o.appendChild(e), b.log(o.parentNode.innerHTML), d.body.appendChild(g), h.xhr.node = g, h.readyState = 2, o.submit(), o = null;
      } else {
        if (k = k.replace(/([a-z]+)=(\?)&?/i, ""), this.xhr && this.xhr.aborted) return void b.log("Error: already aborted");if (g = h.xhr = b.getXHR(), e.params && (k += (k.indexOf("?") < 0 ? "?" : "&") + e.params.join("&")), g.open("POST", k, !0), b.withCredentials && (g.withCredentials = "true"), c.headers && c.headers["X-Requested-With"] || g.setRequestHeader("X-Requested-With", "XMLHttpRequest"), b.each(c.headers, function (a, b) {
          ...
          g.upload && g.upload.addEventListener("progress", b.throttle(function (a) {
            ...
            var a = parseInt(g.getResponseHeader("X-Last-Known-Byte"), 10);if (h.status = g.status, h.statusText = g.statusText, h.readyState = g.readyState, 4 == g.readyState) {
              ...
              } catch (i) {}if (g.onreadystatechange = null, !g.status || g.status - 201 > 0) {
                if (b.log("Error: " + g.status), (!g.status && !g.aborted || 500 == g.status || 416 == g.status) && ++e.retry <= c.chunkUploadRetry) {
                  var j = g.status ? 0 : b.chunkNetworkDownRetryTimeout;c.pause(e.file, c), b.log("X-Last-Known-Byte: " + a), a ? e.end = a : (e.end = e.start - 1, 416 == g.status && (e.end = e.end - c.chunkSize)), setTimeout(function () {
                    h._send(c, e);
                  }, j);
                } else h.end(g.status);
          ...
          }, e.start = e.end + 1, e.end = Math.max(Math.min(e.start + c.chunkSize, e.size) - 1, e.start);var q = e.file,
              r = (q.slice || q.mozSlice || q.webkitSlice).call(q, e.start, e.end + 1);e.size && !r.size ? setTimeout(function () {
            h.end(-1);
          ...
          g.setRequestHeader("Content-Type", "multipart/form-data; boundary=_" + b.expando);var s = e.join("") + "--_" + b.expando + "--";if (g.sendAsBinary) g.sendAsBinary(s);else {
  ...
  function c(a) {
    ...
    "function" == typeof e && (g = e, e = {}), e = b.extend({}, { width: "100%", height: "100%", start: !0 }, e), d.jquery && (d = d[0]);var h = function h(a) {
      ...
      var k = f.createElement("video");k.style.width = c(e.width), k.style.height = c(e.height), a.jQuery ? jQuery(d).empty() : d.innerHTML = "", d.appendChild(k), h();
  ...
  var d = a.document,
    ...
    function h(a) {
      ...
      function b(a) {
        var b, c;if (b = c = 0, a.offsetParent) do {
          b += a.offsetLeft, c += a.offsetTop;
        } while (a = a.offsetParent);return { left: b, top: c };
      }a.getBoundingClientRect(), d.body, (a && a.ownerDocument).documentElement;return { top: b(a).top, left: b(a).left, width: a.offsetWidth, height: a.offsetHeight };
    }var r = c.uid(),
        s = 0,
        t = {},
        u = /^https?:/i,
        v = { _fn: {}, publish: function publish(a, b, d) {
        ...
        var a = d.body && d.body.firstChild;if (a) do {
          if (1 == a.nodeType) {
            c.log("FlashAPI.state: awaiting");var b = d.createElement("div");return b.id = "_" + r, i(b, { top: 1, right: 1, width: 5, height: 5, position: "absolute", zIndex: 1e6 + "" }), a.parentNode.insertBefore(b, a), void v.publish(b, r);
          }
      ...
      }, disableMouseover: !1, mouseover: function mouseover(a) {
          ...
          var b = c.event.fix(a).target;if (/input/i.test(b.nodeName) && "file" == b.type && !b.disabled) {
            var e = b.getAttribute(r),
              ...
              if ("i" == e || "r" == e) return !1;if ("p" != e) {
                b.setAttribute(r, "i");var g = d.createElement("div");if (!f) return void c.log("[err] FlashAPI.mouseover: js-fileapi-wrapper not found");i(g, { top: 0, left: 0, width: b.offsetWidth, height: b.offsetHeight, zIndex: 1e6 + "", position: "absolute" }), f.appendChild(g), v.publish(g, c.uid()), b.setAttribute(r, "p");
              }return !0;
            }if (f) {
        ...
        c.flashEngine = !0, j(c, { readAsDataURL: function readAsDataURL(a, b) {
            k(a) ? this.parent.apply(this, arguments) : (c.log("FlashAPI.readAsBase64"), v.readInProgress = !0, v.cmd(a, "readAsBase64", { id: a.id, callback: l(function d(e, f) {
                v.readInProgress = !1, m(d), c.log("FlashAPI.readAsBase64:", e), b({ type: e ? "error" : "load", error: e, result: "data:" + a.type + ";base64," + f });
              }) }));
          }, readAsText: function readAsText(b, d, e) {
          ...
          }, getFiles: function getFiles(a, b, d) {
            ...
            if (k(a)) this.parent.apply(this, arguments);else if (a.isShot) b(null, a.info = { width: a.width, height: a.height });else {
              if (!a.__info) {
                var d = a.__info = c.defer();d.resolve(null, a.info = null);
              }a.__info.then(b);
            }
  ...
  "use strict";
  var d = c.each,
      e = [];c.support.flash && c.media && !c.support.media && !function () {
    function a(a) {
